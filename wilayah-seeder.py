...
# the data will be inserted into the table wilayah
...
# the data will be inserted into the database
# please generate DDL for the table wilayah
# please generate python code to insert the data into the table wilayah from the file in path/dir wilayah, the sequence of the data must be maintained by the file name in the directory
...
for file in files:
    ...
    for item in data:
        ...
        cur.execute(
            "INSERT INTO wilayah ( kode_wilayah, nama,id_level_wilayah, mst_kode_wilayah, induk_provinsi, kode_wilayah_induk_provinsi, induk_kabupaten, kode_wilayah_induk_kabupaten) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)",
