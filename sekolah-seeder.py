...
# <https://referensi.data.kemdikbud.go.id/pendidikan/dikmen/050725/3>
...
# the data will be inserted into the table dapo_sekolah
...
# please generate DDL for the table dapo_sekolah
# here is DDl for the table dapo_sekolah

# CREATE TABLE dapo_sekolah (
# 	sekolah_id UUID PRIMARY KEY,	
#     nama VARCHAR(255),
#     npsn VARCHAR(10),
#     kode_wilayah_induk_kecamatan VARCHAR(8),
...
# please generate python code to insert the data into the table dapo_sekolah from the file in path/dir sekolah, the sequence of the data must be maintained by the file name in the directory
...
path_to_json = os.path.join('json', 'sekolah')
...
for index, js in enumerate(json_files):
    with open(os.path.join(path_to_json, js)) as json_file:
        ...
        execute_values(cur, "INSERT INTO dapo_sekolah (sekolah_id, nama, npsn,  kode_wilayah_induk_kecamatan, bentuk_pendidikan, status_sekolah, sinkron_terakhir, sekolah_id_enkrip) VALUES %s", tuple_data)
        conn.commit()
